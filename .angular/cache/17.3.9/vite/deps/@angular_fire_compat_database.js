...
} from "./chunk-IUHMWSA2.js";
import {
  isPlatformServer
} from "./chunk-V6OI6PYS.js";
import {
  Inject,
  Injectable,
  InjectionToken,
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name4, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-GS3OKHQM.js"))), map(() => ɵfirebaseAppFactory(options, zone, name4)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
